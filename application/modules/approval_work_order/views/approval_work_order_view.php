f 
	...
	<!-- detail data approval_work_order -->
   ...
   <script type="text/javascript">
    ...
    var daftar_materi = $('#daftar_materi').DataTable();
	 ...
	 function Show_Detail(id){ 
		...
		$.ajax({
			 url:"<?php echo base_url(); ?>approval_work_order/get_data_edit/"+id,
			 type:"GET",
			 dataType:"JSON", 
	 ...
	 function Hapus_Data(id){
        ...
        $.ajax({
            url : "<?php echo base_url('approval_work_order/hapus_data')?>/"+id,
            type: "GET",
            dataType: "JSON",
	...
	function Simpan_Data(){
        ...
        console.log(formData);
            ...
            $.ajax({
             url:"<?php echo base_url(); ?>approval_work_order/simpan_data",
             type:"POST",
             data:formData, 
             contentType:false,  
             processData:false,   
	 ...
	 $('.datepicker').bootstrapMaterialDatePicker({
       ...
       $(document).ready(function() {
		...
		$("#addmodal").on("click",function(){
            ...
            $.get("<?php echo base_url('approval_work_order/header_wo'); ?>",function(result){
                // console.log(result);
	    ...
	    $('#daftar_sales').DataTable( {
            "ajax": "<?php echo base_url(); ?>approval_work_order/fetch_kategori" 
        });
